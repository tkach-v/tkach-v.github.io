...
const SquareClip = ({ width = 16, height = 16 }: Props) => {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="22" height="22" rx="2" fill="#050A0B" />
      <g clip-path="url(#clip0_622_23995)">
        <path
          ...
          stroke="#D7EAEF" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
        <clipPath id="clip0_622_23995">
          <rect width={width} height={height} fill="white" transform="translate(3 3)" />
        </clipPath>
      </defs>
    </svg>
  );
